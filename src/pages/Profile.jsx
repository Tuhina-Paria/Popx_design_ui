      ...
      <div className="p-6 flex-1 flex flex-col bg-gray-100">
        <div className="flex items-center gap-5 mb-6">
          <div className="relative w-76px h-76px">
            ...
            />
            <div className="absolute bottom-0 right-0 bg-popx-purple w-5 h-5 rounded-full flex items-center justify-center border-2 border-white cursor-pointer hover:bg-purple-700 transition-colors shadow-sm">
          ...
          <div className=" mt-0flex flex-col">
