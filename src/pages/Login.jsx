...
const InputField = ({ label, type, placeholder, value, onChange }) => {
  return (
    <div className="relative mb-4">
      <fieldset className="border border-gray-300 rounded-md px-2 pb-2 pt-1 focus-within:border-popx-purple focus-within:border-2 transition-colors duration-200">
...
function Login() {
  ...
  return (
    <div className="h-full  p-6 pt-10 flex flex-col">
      <div className="mb-8">
  ...
  <div >
    <button
      ...
      className={`w-full mt-2 py-3 rounded-md font-semibold text-[15px] transition-colors ${
        isFormFilled 
          ? 'bg-popx-purple text-white hover:bg-purple-700' 
          : 'bg-popx-light-purple text-white cursor-not-allowed'
      }`}
    >
      Login
    </button>
